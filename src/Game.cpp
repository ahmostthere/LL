...
void Game::handleInputs()
{
	...
	while (m_window.pollEvent(currentEvent))
	{
		...
		case sf::Event::KeyPressed:
			...
			case (sf::Keyboard::P):
			{
				std::cout << "viewcenter pos: " << mainView.getCenter().x << ", "
						  << mainView.getCenter().y << std::endl;
				std::cout << "defaultviewcenter pos: "
						  << m_window.getDefaultView().getCenter().x << ", "
						  << m_window.getDefaultView().getCenter().y << std::endl;
				std::cout << "hudviewcenter pos: " << hudView.getCenter().x << ", "
						  << hudView.getCenter().y << std::endl;
				std::cout << "camBound pos: " << camBound.getPosition().x << ", "
						  << camBound.getPosition().y << std::endl;
				break;
			}
		...
		case sf::Event::MouseButtonPressed:
			if (sf::Mouse::isButtonPressed(sf::Mouse::Right))
			{
				sf::Vector2f dest_pos = sf::Vector2f(
					sf::Mouse::getPosition(m_window).x + mainView.getCenter().x -
						m_window.getDefaultView().getCenter().x,
					sf::Mouse::getPosition(m_window).y + mainView.getCenter().y -
